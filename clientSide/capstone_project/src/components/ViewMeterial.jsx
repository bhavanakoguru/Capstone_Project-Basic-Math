        ...
        <div className="imagedata">
            <div className="unit">
                ...
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://docs.google.com/document/d/18d15DKJ_9amUmN41474PhzWTMvV4HV5gzjYypyP7Ww4/edit?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div><br></br>
            <div className="unit">
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://docs.google.com/document/d/1Ebp1udkKnw6tSYdM-EjWH8FJu4t4A4Ql9xX4ABgifOU/edit?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
            ...
            <div className="unit">
                ...
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1rVguQBAPptJxfdWBIZ242ftiW6oPZsqK/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
...
Solving methods include substitution, elimination, or matrix techniques.</p>
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1cMnsJYNyc_DUZX4WT58YpRbxWv4lFQqK/view?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
            ...
            <div className="unit">
                ...
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1sPqpn1MobaEXKMb_1dX0d4DswjBHMZz2/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
            ...
            <div className="unit">
                ...
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1clo_fMwWBjjErzZmPYSAc_6ey7BfJ_o1/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
                    ...
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/152TEFNeoxGTrXky9FLrE1nGkab1h9_Kk/view?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
...
Tangents help determine angles and theorems, while secants have applications in solving geometric problems involving circles.</p>
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1SnLWkmHtbxdatD7wHljajYnkVOTFL2x_/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
...
Applied in fields like engineering, architecture, physics, and daily life for practical measurements and calculations.</p>
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1s_bXr6JmSo16ibLZN3jGZNvdjraR_oTh/view?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
...
Applied in physics, engineering, navigation, and other fields for wave analysis and triangle-related problem solving.</p>
                       <button className="certifybtn"><a  href="https://drive.google.com/file/d/1BzjDFDXQTxzrs2Bzc4EotTFK2j757ia-/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
...
Trigonometry plays a vital role in various fields, aiding in problem-solving related to angles, distances, and wave behavior.</p>
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1TpyqkDUSbNqMeQvfm64BMR0xLTpuMkeQ/view?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
...
Probability helps make informed decisions, assess risks, and understand the likelihood of different outcomes.</p>
                    <button className="certifybtn"><a  href="https://drive.google.com/file/d/1f9rKRcVJ05g76InIfigzTpZR6SgSd8X7/view?usp=sharing">ClickTOLearn</a></button>
                </div>
            </div>
            <div className="unit">
                <div className="subimagedata">
...
Statistics helps understand relationships, trends, and make predictions based on data analysis.</p>
                    <button className="certifybtn"><a href="https://drive.google.com/file/d/1Lh9NCF_60RXJJsDt_fBUh4Kpa4wCztFG/view?usp=sharing">ClickTOLearn</a></button>
                </div>
                <div className="subimg">
